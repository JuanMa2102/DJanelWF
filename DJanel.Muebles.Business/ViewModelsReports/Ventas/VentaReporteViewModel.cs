...
namespace DJanel.Muebles.Business.ViewModelsReports.Ventas
{
    public class VentaReporteViewModel: INotifyPropertyChanged
    {
        ...
        #region Constructor
        public VentaReporteViewModel(IVentaRepository repository)
        {
        ...
        public async Task GetAllAsync()
        {
            ...
            {
                TotalVentas = 0;
                var x = await Repository.GetReporteVentaAsync(startDate, endDate);
                ListaReporte.Clear();
